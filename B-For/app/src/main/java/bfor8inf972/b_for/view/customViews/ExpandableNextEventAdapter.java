...
/**
 * Adapter for R.layout.expandable_event_parent and R.layout.expandable_next_event_child
 */
public class ExpandableNextEventAdapter extends BaseExpandableListAdapter {

    private Context context;
    private ArrayList<Party> parties;

    public ExpandableNextEventAdapter(Context context, ArrayList<Party> parties) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = layInflater.inflate(R.layout.expandable_next_event_child, null);
        }
    ...
    public void setListViewHeight(ExpandableListView listView, int group) {
        ExpandableNextEventAdapter listAdapter = (ExpandableNextEventAdapter) listView.getExpandableListAdapter();
        int totalHeight = 0;
